...
import { ArrowLeft, Calendar, Car, Users, Fuel, Check, ArrowRight } from "lucide-react";
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
                ...
                <div className="pt-4 border-t">
                  ...
                  <Button className="w-full bg-rentwheels-blue hover:bg-rentwheels-blue-dark text-white py-6">
